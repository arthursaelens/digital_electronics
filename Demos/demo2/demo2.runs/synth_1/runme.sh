...
HD_PWD='C:/Users/arthu/Documents/digitale-elektronica/digielek-git/digielek/Demos/demo2/demo2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_encoder_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_encoder_board.tcl
